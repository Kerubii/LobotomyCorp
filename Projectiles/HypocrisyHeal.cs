...
{
    public class HypocrisyHeal : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            for (int num440 = 0; num440 < 2; num440++)
            {
                ...
                int num443 = Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width, Projectile.height, DustID.Grass, 0f, 0f, 100, default(Color), 1.3f);
