	...
	public class ForgottenR : ModProjectile
	{
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            if (Projectile.ai[0] == 0)
            {
                ...
                tex = Mod.Assets.Request<Texture2D>("Projectiles/ForgottenR2").Value;
            }
            else
                position.X += 4 * owner.direction;
            ...
            Main.EntitySpriteDraw(tex, position, Terraria.Utils.Frame(tex, 1, 2), lightColor, Projectile.rotation - 0.785f, Origin, Projectile.scale, 0, 0);
            return false;
        }
    }
}
