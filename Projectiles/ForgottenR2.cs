...
namespace LobotomyCorp.Projectiles
{
	public class ForgottenR2 : ModProjectile
	{
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Main.EntitySpriteDraw(tex, position, Terraria.Utils.Frame(tex, 1, 2, 0, frame), lightColor, Projectile.rotation - 0.785f, Origin, Projectile.scale, 0, 0);
            return false;
        }
    }
    ...
    {
        public override string Texture => "LobotomyCorp/Projectiles/ForgottenR";
        ...
        public override void AI()
        {
            ...
            if (Projectile.ai[0] < 0)
            {
                ...
                {
                    if (p.active && p.owner == Projectile.owner && p.type == ModContent.ProjectileType<Projectiles.ForgottenR2>())
            ...
            else
            {
                ...
                if (!p.active || p.type != ModContent.ProjectileType<Projectiles.ForgottenR2>())
                    Projectile.Kill();
            }
